...
!EOP
  ...
  INTEGER :: tasks  ! Read number of model tasks
  ...
  CALL MPI_Comm_split(COMM_ensemble, my_color, mype_world, &
       COMM_filter, MPIerr)
  ...
  CALL MPI_Comm_split(COMM_ensemble, color_couple, mype_world, &
       COMM_couple, MPIerr)
