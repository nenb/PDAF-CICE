!  SVN:$Id: ice_init.F90 1076 2015-11-11 04:41:22Z eclare $
!=======================================================================
...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_forcing, only: &
          ...
          qdp_data_type, uwat_data_type ! CPOM
      ...
      namelist /forcing_nml/ &
        ...
        qdp_data_type,  uwat_data_type,   tfrz_option
      ...
      qdp_data_type   = 'default' ! CPOM 
      uwat_data_type  = 'default' ! CPOM
      atm_data_dir    = ' '
      ...
      call broadcast_scalar(qdp_data_type,      master_task) ! CPOM
      call broadcast_scalar(uwat_data_type,     master_task) ! CPOM 
      ...
      if (my_task == master_task) then
         ...
         write(nu_diag,*)    ' qdp_data_type             = ', &  !CPOM 
                               trim(qdp_data_type)
         write(nu_diag,*)    ' uwat_data_type            = ', &  !CPOM
                                trim(uwat_data_type)
