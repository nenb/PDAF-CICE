!  SVN:$Id: ice_shortwave.F90 1120 2016-04-08 22:19:36Z eclare $
!=======================================================================
!
      ...
      ! BPB 19 Dec 2006
         ...
         elseif (tr_pond_topo) then
            do ij = 1, icells
               ...
               ! If pond depth < snow depth => no ponds for dEdd !!!
               ! David
!               IF (i.eq.10.and.j.eq.80) print*, "pond snow: ",n,my_task,hpn(i,j), hsn(i,j)
               if (hpn(i,j) < hsn(i,j)) then
                  fpn(i,j) = c0
                  hpn(i,j) = c0
               endif
